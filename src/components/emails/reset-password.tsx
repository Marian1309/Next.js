...
const ResetPasswordEmail = ({ username, resetUrl, userEmail }: Properties) => {
  return (
        ...
        <Body className="bg-gray-100 py-[40px] font-sans">
          <Container className="mx-auto max-w-[600px] rounded-[8px] bg-white p-[40px] shadow-sm">
            ...
            <Section className="mb-[32px]">
              ...
              <Link href={resetUrl} className="text-[14px] break-all text-blue-600">
                {resetUrl}
              </Link>
            </Section>
            ...
            <Section className="mb-[32px]">
              <Text className="m-0 text-[14px] leading-[20px] text-gray-600">
                ...
                <Link href="mailto:support@gmail.com" className="text-blue-600">
                  support@gmail.com
                </Link>
              </Text>
            </Section>
            ...
            <Section className="border-t border-gray-200 pt-[24px]">
              ...
              <Text className="m-0 mb-[8px] text-[12px] leading-[16px] text-gray-500">
                Company Name, Bilyavyntsi, Lisova 10
              </Text>
